...
- **🎯 Assertions nativas do Python**: validações claras e objetivas com `assert`
...
- Foque na clareza do código, usando as asserções nativas (`assert`).
...
### 🏷️ Exemplos de marcações Allure nos Testes (Decorators)
